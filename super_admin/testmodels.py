...
class OtherEnrolled(models.Model):
    ...
    university = models.ForeignKey(OtherUniversity,on_delete=models.CASCADE, null=True,blank=True)
    course = models.ForeignKey(OtherCourse,on_delete=models.CASCADE, null=True,blank=True)
    stream = models.ForeignKey(OtherStream,on_delete=models.CASCADE, null=True,blank=True)
