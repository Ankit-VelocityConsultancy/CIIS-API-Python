# Generated by Django 5.1.3 on 2025-08-28 05:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Job_Portal_AdditionalBenefit',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_jobseeker', models.BooleanField(blank=True, default=False, null=True)),
                ...
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='super_admin.role')),
            ],
            options={
                'db_table': 'user',
            },
        ...
        migrations.CreateModel(
            name='JobSeekerEmploymentDetails',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('current_job_title', models.CharField(default='', max_length=100)),
                ('current_city', models.CharField(default='', max_length=100)),
                ('start_date', models.DateField(blank=True, null=True)),
                ('end_date', models.DateField(blank=True, null=True)),
                ('is_current_job', models.BooleanField(default=False)),
                ('annual_salary', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_status', models.CharField(blank=True, choices=[('experienced', "I'm experienced"), ('fresher', "I'm a fresher"), ('student', "I'm a student")], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='work_preferences', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_one', models.CharField(blank=True, max_length=100, null=True)),
                ('mobile_two', models.CharField(blank=True, max_length=100, null=True)),
                ('mobile_three', models.CharField(blank=True, max_length=100, null=True)),
                ('email', models.CharField(blank=True, max_length=100, null=True)),
                ('email_one', models.CharField(blank=True, max_length=100, null=True)),
                ('email_two', models.CharField(blank=True, max_length=100, null=True)),
                ('email_three', models.CharField(blank=True, max_length=100, null=True)),
                ('followup_date', models.DateField(blank=True, null=True)),
                ('mobile_numbers', models.JSONField(blank=True, default=dict, null=True)),
                ('email_addresses', models.JSONField(blank=True, default=dict, null=True)),
                ('common_lead_label_tags', models.JSONField(blank=True, default=list, null=True)),
                ('lead_comments', models.JSONField(blank=True, default=list, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('activity_log', models.JSONField(blank=True, default=list, null=True)),
                ('co_owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='leads_as_co_owner', to=settings.AUTH_USER_MODEL)),
                ('lead_categories', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='super_admin.categories')),
                ('lead_color', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='super_admin.color')),
                ...
                ('lead_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='super_admin.rolestatus')),
                ('lead_source', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='super_admin.source')),
                ('university', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='super_admin.university')),
            ],
            options={
                'db_table': 'leads',
            },
        ...
        migrations.CreateModel(
            name='Leads_Addditional_Details',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('company_name', models.CharField(blank=True, max_length=100, null=True)),
                ('address', models.TextField()),
                ('branch_area', models.CharField(blank=True, max_length=100, null=True)),
                ('city', models.CharField(blank=True, max_length=100, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='super_admin.countries')),
                ('lead', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='super_admin.leads')),
                ('state', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='super_admin.states')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='super_admin.examination')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='super_admin.student')),
                ('examdetails', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='super_admin.studentappearingexam')),
            ],
            options={
                'db_table': 'result',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('applied', 'Applied'), ('viewed', 'Viewed'), ('shortlisted', 'Shortlisted'), ('interviewing', 'Interviewing'), ('rejected', 'Rejected'), ('hired', 'Hired')], default='applied', max_length=20)),
                ('application_date', models.DateTimeField(auto_now_add=True)),
                ('last_status_change', models.DateTimeField(auto_now=True)),
                ('resume_viewed', models.BooleanField(default=False)),
                ('resume_viewed_at', models.DateTimeField(blank=True, null=True)),
                ('application_viewed', models.BooleanField(default=False)),
                ('application_viewed_at', models.DateTimeField(blank=True, null=True)),
                ('notes', models.TextField(blank=True, null=True)),
                ('job_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='super_admin.jobpost')),
